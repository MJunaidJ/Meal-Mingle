...
<body class="home">
    ...
    <button type="submit" class="btn theme-btn btn-lg">Search dishes</button>
</form>
                    </div>
                    <div class="steps">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Call us at: <a href="tel:+92 12312331564">+92 1234567890</a></h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Who are we?</h5>
                            <p>We are students of NEDUET who have made a proof of concept website for out project</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
