...
<body>
    ...
    <div class="bg-gray restaurant-entry">
        <div class="row">
            <?php
            // Database connection
            // Assume $db is the connection variable
            ...
            $total_query = mysqli_query($db, "SELECT COUNT(*) AS total FROM restaurant");
            $total_row = mysqli_fetch_array($total_query);
            $total_records = $total_row['total'];
            $number_of_pages = ceil($total_records / $limit);

            // Fetch the limited records for the current page
            $ress = mysqli_query($db, "SELECT * FROM restaurant LIMIT $limit OFFSET $offset");
