...
?>
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="search.php?search=<?php echo $_GET['search']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <a href="checkout.php?search=<?php echo $_GET['search'];?>&action=check"  class="btn btn-danger btn-lg disabled">Checkout</a>

                                        <?php
                                        }
                                        else{
                                        ?>
                                        <a href="checkout.php?search=<?php echo $_GET['search'];?>&action=check"  class="btn btn-success btn-lg active">Checkout</a>
                                        <?php
                                        }
                                        ?>
                                    </div>
    ...
    <div class="menu-widget" id="2">
        ...
        <div class="collapse in" id="popular2">
            ...
            $stmt = $db->prepare("SELECT * FROM dishes WHERE title LIKE ?");
            ...
            $stmt = $db->prepare("SELECT * FROM dishes WHERE title LIKE ? LIMIT ?, ?");
            $stmt->bind_param("sii", $search_term, $start_limit, $results_per_page);
            $stmt->execute();
                    ...
                    <div class="food-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-8">
                                <form method="post" action='search.php?search=<?php echo $_GET['search']; ?>&action=add&id=<?php echo $product['d_id']; ?>'>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    for ($page_num = 1; $page_num <= $number_of_pages; $page_num++) {
                        echo '<li class="page-item ' . ($page_num == $page ? 'active' : '') . '">
                                <a class="page-link" href="search.php?search=' . $_GET['search'] . '&page=' . $page_num . '">' . $page_num . '</a>
                              </li>';
                    }
                    ?>
                </ul>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/logo.png" alt="Footer logo"> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
